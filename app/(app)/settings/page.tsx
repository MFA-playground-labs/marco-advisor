...
const checks = [
  ["Supabase URL", "NEXT_PUBLIC_SUPABASE_URL", true],
  ["Supabase anon key", "NEXT_PUBLIC_SUPABASE_ANON_KEY", true],
  ["OpenAI API key", "OPENAI_API_KEY", true],
  ["Supabase service role", "SUPABASE_SERVICE_ROLE_KEY", false]
] as const;
